...
const AutoPilot = () => {
  return (
    <div className="bg-[#01041A] text-white flex flex-col gap-4 justify-center md:px-40 px-4 md:py-16  items-center w-full h-auto">
      <AnimateFromInside>
        <p className="font-semibold md:text-[64px] sm:text-[48px] text-[38px] leading-[100%] text-white font-degular text-center">
          Trade On Auto-Pilot
        </p>
      </AnimateFromInside>
      <AnimateFromInside>
        <p className="font-normal md:text-[24px] sm:text-[18px] text-[14px] md:leading-[33px] tracking-normal leading-[22px] text-center text-[#FFFFFFBF]/[0.75]">
